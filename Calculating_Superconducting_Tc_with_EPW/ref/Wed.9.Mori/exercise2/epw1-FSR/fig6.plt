...
plot "mgb2.lambda_pairs" w l lw 2 dt 1 lc rgb "black" notitle
...
plot "mgb2.lambda_k_pairs" w l lw 2 dt 1 lc rgb "black" notitle
...
set key spacing 1.5
plot "< tail -n +2  mgb2.a2f | head -n 500"  w l lw 2 dt 1 lc rgb "black" title "α^2F(ω)", \
