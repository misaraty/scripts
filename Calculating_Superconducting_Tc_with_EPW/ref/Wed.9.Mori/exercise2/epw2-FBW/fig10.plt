...
set xrange [0:180]
set yrange [-2:15]
plot "mgb2.imag_aniso_010.00" u ($1*1000):($4*1000) with points pt 7 ps 0.2 lc rgb "black" notitle
...
plot "mgb2.pade_aniso_010.00" u ($1*1000):($5*1000) with points pt 7 ps 0.1 lc rgb "black" notitle
